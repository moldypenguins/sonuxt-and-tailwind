<!--
  Purpose: Embed promotional video with lazy loading and controls.
  Convention: Comments concise; avoid autoplay; use accessible controls.
  Performance: Defer loading; optimize source formats.
-->
<template>
  <div class="relative">
