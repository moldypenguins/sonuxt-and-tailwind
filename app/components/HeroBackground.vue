<!--
  Purpose: Decorative hero background visuals.
  Convention: Comments concise; prefer CSS/Tailwind; lazy-load heavy assets.
  Performance: Optimize images and avoid blocking scripts.
-->
...
<template>
  <div
    ...
    :class="[isLoading ? 'animate-pulse' : appear ? '' : 'opacity-0', appeared ? 'duration-400' : 'duration-1000']"
  >
